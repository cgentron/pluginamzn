...
protoc --go_out=plugins=grpc:. -I./gen -I. --go_opt=module=github.com/cgentron/pluginamzn cgentron/amazon/messages.proto
protoc --go_out=plugins=grpc:. -I./gen -I. --go_opt=module=github.com/cgentron/pluginamzn cgentron/amazon/lambda.proto
